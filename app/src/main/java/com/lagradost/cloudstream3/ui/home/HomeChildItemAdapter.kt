...
class ResumeItemAdapter(
    ...
    override fun onCreateFooter(parent: ViewGroup): ViewHolderState<Boolean> {
        ...
        val binding = if (expanded) HomeRemoveGridExpandedBinding.inflate(inflater, parent, false) else HomeRemoveGridBinding.inflate(inflater, parent, false)
...
open class HomeChildItemAdapter(
    ...
    companion object {
        ...
        fun updatePosterSize(context: Context, value: Int? = null) {
            ...
            minPosterSize = (118.toPx.toFloat() * mul).toInt()
            maxPosterSize = (168.toPx.toFloat() * mul).toInt()
        }
